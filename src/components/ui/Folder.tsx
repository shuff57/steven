...
export function Folder({ 
  ...
  const getOpenTransform = (index: number) => {
    ...
    if (index === 1) return 'translate(60%, -100%) rotate(-5deg)';
    if (index === 2) return 'translate(90%, -30%) rotate(10deg)';
    return '';
  };

  return (
    <div style={scaleStyle} className={`print:hidden ${className}`}>
      <div
          ...
          {papers.map((item, i) => {
            ...
            return (
              <div
                ...
                style={{
                  ...(!open 
                        ? (peeking ? { transform: `translateX(-50%) translateY(-15%)` } : {}) 
