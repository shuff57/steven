...
export const projects: Project[] = [
  ...
  },
  {
    ...
    status: 'concept',
    featured: false,
    repoUrl: 'https://github.com/shuff57/shDev',
  ...
  },
  {
    id: 'shcode',
    title: 'shCode',
    subtitle: 'Full-stack classroom platform for teaching JavaScript',
    description:
      'A Next.js classroom platform built for teaching an introductory JavaScript + shplay high school CS course. Students work through lessons and assignments in a browser-based CodeMirror editor with live autograding, an AI-assisted written-response grader (via Ollama), and per-student progress tracking. Teachers and admins manage classes with join codes, review submissions, and push updates to student work. Deployed as a static Next.js export on Cloudflare Pages, backed by Cloudflare Pages Functions and a D1 (SQLite) database, with role-based auth (admin/teacher/student) enforced through signed session cookies.',
    dateStart: '2025',
    dateEnd: null,
    status: 'active',
    featured: true,
    repoUrl: 'https://github.com/shuff57/shCode',
    videoUrl: '/videos/shCode-demo.mp4',
    type: 'tool',
  },
